...
const apple = () => {
  ...
  for (let i = 0; i < layer; i++) {
    ...
    for (let i = 0; i <= segments; i++) {
      for (let j = 0; j <= segments; j++) {
        ...
        let z = Math.pow(j, 0.5) * 10 - 0.03 * j * internal;
  ...
  */
  ...
  //   group2.add(plane);
  // }
  // group2.rotation.y = Math.PI * 0.15;
  // group2.rotation.x = Math.PI * 0.15;
  ...
  //   group3.add(plane);
  // }
  // group3.rotation.y = -Math.PI * 0.15;
  // group3.rotation.x = -Math.PI * 0.15;
  ...
  //   group4.add(plane);
  // }
  // group4.rotation.y = Math.PI * 0.15;
  // group4.rotation.x = -Math.PI * 0.15;
...
/*                                     GUI                                    */
/* -------------------------------------------------------------------------- */
// gui.add(parameters, "q").min(0.01).max(0.3).step(0.01).onFinishChange(apple);
// gui
